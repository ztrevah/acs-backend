...
namespace SystemBackend.Migrations
{
    ...
    [Migration("20250706032640_remove unique constraint (roomId, memberId) of roommembers, add index, use datetime2(3)")]
    partial class removeuniqueconstraintroomIdmemberIdofroommembersaddindexusedatetime23
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SystemBackend.Models.Entities.RoomMember", b =>
                {
                    ...
                    b.HasIndex("DisabledStartTime", "DisabledEndTime");
